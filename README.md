...
If you create a token.json file in src with `{"token":"AIzaXXXXXXXXXXXXXX"}` you will not be prompted to enter it each time

<small>Below is autogenerated by create react app
## Available Scripts
